...
def display(request):
    json = {"nodes": [
        {"monitor_id": 2, "name": "qqq", "id": 0, "type": "EducationalOrganization,HighSchool,Organization,Thing"},
        {"monitor_id": 2, "name": "aaa", "id": 2, "type": "Person,Thing"}, {"monitor_id": 2, "name": "vvv", "id": 1,
                                                                            "type": "EducationalOrganization,ElementarySchool,Organization,Thing"}],
            "links": [{"source": 2, "target": 1, "type": "毕业于"}]}
    return render(request, "KGPage/display.html", {"data": json})
